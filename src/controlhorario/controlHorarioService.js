...
export const SECTOR_COLORS = {
  ...
  'AUXILIARES DE HOTELERÍA': '#A855F7',
};
...
const COLABORADORES_SEDE_SF = {
  ...
  'DXI': [
    ...
    'PEREZ YANINA', 'DIAZ DANIELA', 'GORDILLO VEGA MONICA', 'ESPEJO CRISTINA', 'RUARTE DAIANA', 'RUARTE MICAELA',
    // Mamografía y Densitometría
    'OROZCO LAURA MARIENELA', 'TORET ANA BELEN', 'GOMEZ MALVINA SOLEDAD', 'TELLO CECILIA', 'ZARZUELO JULIETA MICAELA', 'OLIVA MARIA VERONICA',
  ],
  'GUARDIAS DE SEGURIDAD': ['GOMEZ JULIO', 'TORRES DAVID'],
  'CHEQUEO Y PREVENIR': ['GODOY GUZMAN GISEL'],
  'AUXILIARES DE HOTELERÍA': [
    'BUSTOS MELISA', 'BUSTOS PATRICIA', 'CASTRO PAULA ROSA', 'CHICAHUALA FLORENCIA',
    'AGUILERA CLARA', 'CANO FLAVIA MIRTA', 'OLIVARES MALENA', 'PUCHOL CARMEN',
    'PUENTEDURA CECILIA', 'HERRERA NADIA GABRIELA', 'HERRERA NADIA MACARENA',
    'MOYANO ANALIA', 'AMARFIL SILVIA', 'ARREDONDO LORENA EDITH',
    'CASTRO CUELLO DANIELA DEL CAR', 'CASTRO GIMENA BELEN', 'MATURANO NORMA ERNESTINA',
    'ALMAGRO EVELIN', 'MOLINA MELINA FERNANDA', 'CORTEZ DEBORA', 'ALVAREZ LOURDES',
    'PAZCEL ESPINOSA MARCELA', 'PEÑA VANESA DOLORES', 'QUIROGA CABELLO IVANA ERICA',
    'RIVEROS SOLANGE', 'ROJO MAIRA BELEN', 'DI CARLO GRISELDA', 'DIAZ CECILIA BELEN',
    'DOMINGUEZ MALENA CECILIA', 'SILVA ROCIO MICAELA', 'GALLEGUILLO VIVIANA', 'GIANGRATE ROCIO',
  ],
};
